...
<body>
    ...
    <?php
    if(isset($_GET['txtsub'])) //Hàm kiểm tra submit đã nhấn chưa
    {
        if(empty($_GET['txtname'])|| empty($_GET['txtmd']))
            echo "Bạn chưa nhập đủ thông tin!!!";
        else
        {
            echo "Giảng viên: ".$_GET['txtname']." - ". "Môn dạy: ".$_GET['txtmd']." - "." Giảng đường: ".$_GET['txtgd'];
        }
    }
    ?>
