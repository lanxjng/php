      ...
      <div class="layout_padding2-top">
        <div class="row">
          <div class="col-lg-4 offset-lg-2 col-md-5 offset-md-1">
            <form action="contact.php" method="post">
              <div class="contact_form-container">
                <div>
                  ...
                  <div>
                    <input type="text" name="nd" class="message_input" placeholder="Message" />
                  </div>
                  <div>
            ...
            <?php
            if(isset($_POST['send'])){
              $ten=$_POST['ten'];$email=$_POST['email'];
              $sdt=$_POST['sdt'];$nd=$_POST['nd'];
              $conn=mysqli_connect('localhost','root','','webphp');
              $sql= "INSERT INTO contact(ten,email,sdt,nd) 
                VALUES('$ten','$email','$sdt','$nd')";
