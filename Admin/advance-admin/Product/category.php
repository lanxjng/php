...
<body>
    <div id="wrapper">
        ...
        $get_data = new data_category(); //Goi lop data giangduong trong trang control
        if(isset($_POST['txtsub']))
        {
            $in_cate = $get_data->insert_cate($_POST['txttencate'], $_POST['txtmotacate']);
            if($in_cate) echo "<script> alert('Thanh cong !!')</script>";
