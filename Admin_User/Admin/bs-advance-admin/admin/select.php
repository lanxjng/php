    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <tr class="k2">
                    <td><h4>Name</h4></td>
                    <td><h4>Number Product</h4></td>
                    <td><h4>picture Product</h4></td>
                    <td><h4>Category Product</h4></td>
                    <td><h4>Date Product</h4></td>
                    <td><h4>Price Product</h4></td>
                    <td><h4>Description Product</h4></td>
                    <td><h4>Update</h4></td>
                    <td><h4>Delete</h4></td>
                </tr>
            ...
            foreach ($select_product as $i_dk)
            {
                ...
                <tr class="k2">
                    ...
                    <td><img src="upload/<?php echo $i_dk['pict'] ?>" alt="" width="100px" height="100px"></td>
                    
                    <td><?php echo $i_dk['cate'] ?></td>
                    
                    <td><?php echo $i_dk['date'] ?></td>
                    <td><?php echo $i_dk['pric'] ?></td>
                    <td><?php echo $i_dk['des'] ?></td>
                    
                    <td ><a href="update.php?up=<?php echo $i_dk['id_product']?>"> Update </a></td>

                    <td><a href="delete.php?del=<?php echo $i_dk['id_product']?>"
