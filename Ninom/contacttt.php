...
<body class="sub_page">
        ...
        <div class="row">
          <div class="col-lg-4 offset-lg-2 col-md-5 offset-md-1">
            ...
            <form method="POST" enctype="multipart/form-data">
                  ...
                  <div>
                    <input type="password" placeholder="Password" name="txtpasswd"/>
                  </div>
                  <div>
                    <input type="password" placeholder="Re_Password" name="txtre_passwd"/>
                  </div>
                  <div>
                    <input type="email" placeholder="Email" name="txtemail"/>
                  </div>
                  <div>
                    <input type="text" placeholder="Adress" name="txtaddress" />
                  </div>
                  <div>
                    <input type="file" placeholder="anh" name="txtfile"/>
                  </div>
                  <div>
  ...
  <?php
    ...
    $get_data = new data_register(); //Goi lop data giangduong trong trang control
    if(isset($_POST['txtsub']))
    {
        $in_dk = $get_data->insert_dk($_POST['txtname'], $_POST['txtphone'],$_POST['txtpasswd'],
        $_POST['txtre_passwd'], $_POST['txtemail'], $_POST['txtaddress'], $_FILES['txtfile']['name']);
        if($in_dk) echo "<script> alert('Thanh cong !!')</script>";
